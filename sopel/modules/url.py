...
def find_title(url, verify=True):
    ...
    response = requests.get(url, stream=True, verify=False, headers={'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36'})
    try:
        content = ''
